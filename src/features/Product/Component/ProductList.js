      ...
      <div>
        <div className="bg-white">
          <div>
            ...
            <MobileFilter handelFilder={handelFilder} mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen}></MobileFilter>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                              ...
                              {({ active }) => (
                                <p
                                  ...
                                  className={classNames(
                                    option.current
                                      ? "font-medium text-gray-900 dsfsdfds"
                                      : "text-gray-500",
                                    active ? "bg-gray-100" : "",
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  {/* Filters */}
                  <DesktopFilter handelFilder={handelFilder}>
...
function MobileFilter({mobileFiltersOpen,setMobileFiltersOpen,handelFilder}) {
...
function DesktopFilter({handelFilder}) {
  return (
    <div>
                    ...
                    {section.options.map((option, optionIdx) => (
                      <div key={option.value} className="flex items-center">
                        <input
                          ...
                          type="checkbox"
                          defaultChecked={option.checked}
                          onChange={(e) => handelFilder(e, section, option)}
                          className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                        />
                        <label
